    ...
    return (
        ...
        <main className="p-4 md:px-16 lg:max-w-6xl lg:mx-auto text-left w-full h-screen flex justify-center items-center">
            <div className="flex flex-col gap-4 relative">
                <img className="w-20 absolute -bottom-24 right-10 " src={Arrow} alt={"Arrow"}/>
                <img className="w-20 absolute md:-top-28 md:-left-10 -top-20" src={Rocket} alt={"Rocket"}/>
                <img className="w-20 absolute md:-top-44 md:right-0 top-20 right-0" src={Star} alt={"Star"}/>
                <img className="w-20 absolute md:-bottom-44 md:left-10 -bottom-32" src={Target} alt={"Target"}/>
                <h1 className="text-4xl lg:text-6xl lg:leading-tight font-bold md:text-center">Streamline Your Hiring Process with<span className="text-blue-500"> Ease </span> and <span className="text-blue-500"><br className="md:hidden"/> Efficiency </span></h1>
                ...
                <div className="grid grid-cols-3 lg:grid-cols-5 rounded-lg">
                    ...
                    <div className="col-span-3 md:col-span-1 lg:col-span-1 mt-4 md:mt-0">
                        <button onClick={() => navigate("/search")} className="p-4 w-full md:h-full text-sm bg-blue-500 hover:bg-blue-600 transition-all duration-300 rounded cursor-pointer text-white font-medium">Search</button>
                    </div>
                </div>
            </div>
